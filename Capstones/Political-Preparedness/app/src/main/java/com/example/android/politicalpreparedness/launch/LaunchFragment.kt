...
class LaunchFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        binding.fragmentLaunchButtonFindMyRepresentatives.setOnClickListener { navToRepresentatives() }
        binding.fragmentLaunchButtonUpcomingElection.setOnClickListener { navToElections() }
